-- INSERTing admin user to quizdb.mv.db table

INSERT INTO user_table (id, email, password, roles, user_name)
VALUES 
    (1, 
...
-- Initial Quiz questions inserted into the localhost:5432/quizdb database

-- SPORT topic
INSERT INTO quiz_table (id, is_multiple_choice, text, timestamp, topic, created_by_id) 
VALUES (1, false, 'When was Wembley Stadium reopened after it was rebuilt', CURRENT_TIMESTAMP, 'SPORT', 1)
ON CONFLICT (id) DO NOTHING;

INSERT INTO options_table (id, option, quiz_id)
VALUES 
    (1, '2007', 1), 
    (2, '1992', 1), 
    (3, '1987', 1), 
...
INSERT INTO answer (id, answer, quiz_id)
VALUES (1, 1, 1)
ON CONFLICT (id) DO NOTHING;
